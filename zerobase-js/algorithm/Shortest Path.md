## 최단 경로 (Shortest Path)
- 가중 그래프에서 구성하는 간선 간 <b>가중치 합이 최소가 되도록 최단 경로</b>를 찾는 알고리즘
- 유형
  - 다익스트라 알고리즘: 단일 최단 경로 최소 비용 산출
  - A* 알고리즘: 휴리스틱 방법 사용한 탐색
  - Bellman-Ford: 알고리즘: 음수 가중치 허용한 비용 산출
  - Floyd-Warshall: 알고리즘: 동적계획법 기반 고차원 기법

### 다익스트라 알고리즘
- 그래프에서 <b>출발점과 도착점 사이의 최단 거리</b>를 구하는 알고리즘
...
## Floyd-Warshall 알고리즘
- <b>동적 계획법</b>을 활용해, 그래프에서 <b>가능한 모든 정점 쌍에 대해 최단 거리</b>를 구하는 알고리즘
